...
http://www.adaltas.com/en/2019/01/09/applying-deep-reinforcement-learning-poker/
 - poker reinforcement

https://pypi.org/project/poker/
 - python framework for poker related operations
https://github.com/worldveil/deuces
 - pure Python poker hand evaluation library
